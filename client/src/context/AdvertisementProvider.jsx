...
import {
  ...
  getAdvertisementRequest,
  updateAdvertisementRequest,
  getAdvertisementsByCourseRequest, // Agregamos la nueva solicitud
} from "../api/advertisements.api";
import { AdvertisementContext } from "./AdvertisementContext";
...
export const AdvertisementContextProvider = ({ children }) => {
  ...
  // Nuevo método para cargar anuncios por curso
  async function loadAdvertisementsByCourse(courseCode) {
    try {
      const response = await getAdvertisementsByCourseRequest(courseCode);
      setAdvertisements(response.data);
    } catch (error) {
      console.error(error);
    }
  ...
  return (
    <AdvertisementContext.Provider
      value={{
        ...
        getAdvertisement,
        updateAdvertisement,
        loadAdvertisementsByCourse, // Agregamos el nuevo método
      }}
    >
      {children}
    </AdvertisementContext.Provider>
