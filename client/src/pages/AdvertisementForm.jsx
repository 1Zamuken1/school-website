  ...
  useEffect(() => {
    const loadAdvertisement = async () => {
      if (params.code) {
        const course = await getAdvertisement(params.code);
        setAdvertisement({
          advertisement_title: course.advertisement_title,
          advertisement_description: course.advertisement_description,
        });
      }
    };
    loadAdvertisement();
  }, [params.code]); // Include params.code as a dependency
    ...
    <div className="mx-auto">
      <Formik
        ...
        onSubmit={async (values, actions) => {
          ...
          // Include the course code in the values
          const updatedValues = {
            ...values,
          ...
          if (params.code) {
            await updateAdvertisement(params.code, updatedValues);
          } else {
            await createAdvertisement(updatedValues);
          }
          navigate("/");
          setAdvertisement({
            advertisement_title: "",
